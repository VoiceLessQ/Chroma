//===============================================================================
// Terrain Vertex Shader (gbuffers_terrain.vsh)
//
// This shader processes vertices for terrain blocks (blocks, dirt, stone, etc.)
...
// - Chunk offset handling for large worlds
//===============================================================================
...
uniform vec3 chunkOffset;        // Offset for chunk-based world rendering
...
void main() {
	...
	// Chunk offset is added to handle large world rendering
	...
	// This can be used for grass color variation, biome tinting, etc.
	tint = vaColor;
}